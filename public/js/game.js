...
const scenarios = [
  // === TIER 1: Easy ===
  {
    ...
    options: [
      {
        text: '🚨 This is a SCAM — The domain "paypa1-secure.com" uses a number "1" instead of "l"',
        correct: true,
      },
      {
        text: "✅ This is LEGITIMATE — PayPal often sends security alerts",
        correct: false,
      },
      {
        text: "🤔 This is SAFE — It mentions a reference number so it must be real",
        correct: false,
      },
      {
        text: "✅ This is LEGITIMATE — I should verify my account immediately",
        correct: false,
      },
    ],
    explanation:
      'This is a classic phishing email. The domain "paypa1-secure.com" uses the number "1" instead of the letter "l" (homograph attack). Real PayPal emails come from @paypal.com. The urgency tactic ("24 hours") is designed to make you act without thinking.',
    tip: "💡 Always check the sender's email domain carefully. Hover over links before clicking to see the real URL.",
  },
  {
    tier: 1,
    type: "prize",
    typeLabel: "🎁 PRIZE SCAM",
    ...
    options: [
      {
        text: "✅ This is REAL — Microsoft is a big company with lottery programs",
        correct: false,
      },
      {
        text: "🚨 This is a SCAM — Legitimate lotteries never ask for bank details via text",
        correct: true,
      },
      {
        text: "🤔 I should reply to get more information first",
        correct: false,
      },
      {
        text: "✅ The reference number proves it's legitimate",
        correct: false,
      },
    ],
    explanation:
      "This is a lottery/prize scam. Red flags: You can't win a lottery you never entered. Microsoft doesn't run lotteries. They're using a @gmail.com address (not @microsoft.com). They're asking for sensitive personal information upfront.",
    tip: "💡 You cannot win a lottery or contest you never entered. Legitimate organizations never ask for bank details via text.",
  },
  {
    tier: 1,
    type: "delivery",
    typeLabel: "📦 DELIVERY SCAM",
    ...
    options: [
      ...
      {
        text: "🤔 I'll click to check if I have any pending deliveries",
        correct: false,
      },
      {
        text: "🚨 This is a SCAM — FedEx doesn't charge redelivery fees via random links",
        correct: true,
      },
      {
        text: "✅ The tracking number looks real so this is legitimate",
        correct: false,
      },
    ],
    explanation:
      'Delivery scams are very common. FedEx and other couriers never send SMS asking for payment through external links. The URL "fedex-redelivery-update.com" is not an official FedEx domain. The $1.99 fee is designed to steal your credit card information.',
  ...
  // === TIER 2: Medium ===
  {
    ...
    options: [
      {
        text: "✅ I should help the CEO — it sounds urgent and important",
        correct: false,
      },
      {
        text: "🚨 This is a SCAM — Real CEOs don't ask employees to buy gift cards via WhatsApp",
        correct: true,
      },
      {
        text: "🤔 I should buy the gift cards but wait to send the codes",
        correct: false,
      },
      {
        text: "✅ The CEO said it's confidential so I should keep it secret",
        correct: false,
      },
    ],
    explanation:
      "This is a CEO/boss impersonation scam. Key red flags: Using personal messaging (WhatsApp) for business, requesting gift cards (untraceable currency), asking for secrecy, and creating urgency. Always verify such requests through official company channels.",
  ...
  },
  {
    ...
    options: [
      {
        text: "✅ I should secure my account immediately via the link",
        correct: false,
      },
      {
        text: "🤔 The details look specific so this must be real",
        correct: false,
      },
      {
        text: '🚨 This is a SCAM — "g00gle-security.com" is not Google\'s real domain',
        correct: true,
      },
      {
        text: "✅ Google often sends these alerts, this looks normal",
        correct: false,
      },
    ],
    explanation:
      'This is a sophisticated phishing email. The domain "g00gle-security.com" uses zeros instead of "o"s. Real Google security alerts come from @google.com or @accounts.google.com. The specific details (Moscow, Russia) are designed to create fear.',
  ...
  },
  {
    ...
    options: [
      {
        text: "✅ I should donate immediately to help the children",
        correct: false,
      },
      {
        text: "🚨 This is a SCAM — Legitimate charities don't use Facebook DMs and crypto for donations",
        correct: true,
      },
      {
        text: "🤔 I should share this message to spread awareness",
        correct: false,
      },
      {
        text: "✅ Save The Children is a real charity so this must be legitimate",
        correct: false,
      },
    ],
    explanation:
      "This exploits emotional manipulation using a real charity's name. Red flags: Direct bank transfers and cryptocurrency (untraceable), extreme urgency, Facebook messages instead of official channels. Real charities have secure donation pages on their official websites.",
  ...
  // === TIER 3: Hard ===
  {
    ...
    options: [
      ...
      {
        text: "🤔 The 7-day deadline seems reasonable, not too urgent",
        correct: false,
      },
      {
        text: '🚨 This is a SCAM — The domain uses a Cyrillic "е" instead of Latin "e" (homograph attack)',
        correct: true,
      },
      {
        text: "✅ The email looks professional so I should verify",
        correct: false,
      },
    ],
    explanation:
      'This is a homograph attack — one of the most sophisticated phishing techniques. The "е" in "chasе.com" is a Cyrillic character that looks identical to the Latin "e" but leads to a completely different domain. These attacks are extremely hard to detect visually.',
  ...
  },
  {
    ...
    options: [
      {
        text: "✅ He has my employee ID and a ticket number — this seems legitimate",
        correct: false,
      },
      {
        text: "🚨 This is a SCAM — IT support NEVER asks for your password over the phone",
        correct: true,
      },
      {
        text: "🤔 I should give my password since he's from IT and has authorization",
        correct: false,
      },
      {
        text: "✅ The VPN migration sounds like a real IT project",
        correct: false,
      },
    ],
    explanation:
      "This is a social engineering (vishing) attack. No legitimate IT department will ever ask for your password — they can reset it without knowing it. The ticket number and employee ID are designed to build false trust. Real VPN migrations don't require user passwords.",
  ...
  },
  {
    ...
    options: [
      {
        text: "✅ Goldman Sachs is reputable, this must be legitimate",
        correct: false,
      },
      {
        text: "🤔 I should research the platform before investing",
        correct: false,
      },
      {
        text: "✅ 30% returns with no risk sounds like a great deal",
        correct: false,
      },
      {
        text: '🚨 This is a SCAM — "Guaranteed" high returns with no risk is impossible',
        correct: true,
      },
    ],
    explanation:
      "This is an investment/crypto scam (likely a Ponzi scheme). No legitimate investment guarantees 30% monthly returns with zero risk — that's mathematically unsustainable. The person may be impersonating a Goldman Sachs employee. Anyone can create fake credentials on LinkedIn.",
  ...
  // === TIER 4: Expert ===
  {
    ...
    options: [
      {
        text: "✅ It's a video call with my manager — I can see it's them",
        correct: false,
      },
      { text: "🤔 I'll process it since the CEO approved", correct: false },
      {
        text: "🚨 This could be a DEEPFAKE — I should verify through another channel before acting",
        correct: true,
      },
      {
        text: "✅ The urgent payment makes sense if a contract was just signed",
        correct: false,
      },
    ],
    explanation:
      "Deepfake video calls are an emerging threat. AI can now clone someone's face and voice in real-time. Red flags: unusual blink patterns, slightly lower video quality, urgent wire transfers, verbal-only authorization. Always verify large financial requests through a separate, known phone call.",
  ...
  },
  {
    ...
    options: [
      {
        text: "✅ CVE numbers look legitimate — I should update immediately",
        correct: false,
      },
      { text: "🤔 I'll run the terminal command to be safe", correct: false },
      {
        text: '🚨 This is a SCAM — The domain "vscode-marketplace.dev" is not Microsoft\'s official domain, and piping curl to bash is dangerous',
        correct: true,
      },
      {
        text: "✅ I should download the patched version from the link",
        correct: false,
      },
    ],
    explanation:
      'This is a supply chain attack targeting developers. The domain "vscode-marketplace.dev" is NOT the real VS Code Marketplace (marketplace.visualstudio.com). The "curl | bash" command would execute arbitrary code on your machine. Real VS Code updates come through the built-in extension manager.',
    tip: '💡 Never run "curl | bash" from untrusted sources. Always update software through official channels, not email links.',
  },
  {
    tier: 4,
    type: "romance",
    typeLabel: "💕 ROMANCE SCAM",
    ...
    options: [
      {
        text: "💕 We have a genuine connection — I should help them",
        correct: false,
      },
      {
        text: "🤔 They said they'll pay me back, so maybe I should help",
        correct: false,
      },
      {
        text: '🚨 This is a ROMANCE SCAM — The "emergency" requesting money is a classic pattern',
        correct: true,
      },
      {
        text: "✅ They've invested 3 weeks talking to me, so their feelings must be real",
        correct: false,
      },
    ],
    explanation:
      'This follows the classic romance scam pattern: 1) Can\'t meet in person (works remotely), 2) Rapidly escalating emotions, 3) Eventually asks for money due to an "emergency." Scammers invest weeks or months building emotional connections before requesting money.',
  ...
  // === TIER 5: Ultimate ===
  {
    ...
    options: [
      {
        text: "✅ She mentions specific details about the conference — must be real",
        correct: false,
      },
      {
        text: "🤔 The file is .xlsx so it should be safe to open",
        correct: false,
      },
      {
        text: "✅ We discussed this at the conference, I should review it",
        correct: false,
      },
      {
        text: "🚨 This is a SCAM — The attachment is .xlsx.exe (executable), and personal details can be harvested from social media",
        correct: true,
      },
    ],
    explanation:
      'This is an AI-powered spear phishing attack. The attacker used AI to scrape your social media for conference attendance, then crafted a hyper-personalized email. The file "Revenue_Analysis_Q4_2026_FINAL.xlsx.exe" has a hidden .exe extension — it\'s malware disguised as a spreadsheet.',
  ...
  },
  {
    ...
    options: [
      {
        text: "✅ The 2FA code came from the real company system, so the caller is legitimate",
        correct: false,
      },
      {
        text: "🤔 Multiple alerts must mean there's a real threat — I should cooperate",
        correct: false,
      },
      {
        text: "🚨 This is a COORDINATED ATTACK — They triggered the real 2FA code to steal it from you",
        correct: true,
      },
      {
        text: "✅ I should give the code to verify my identity and secure my account",
        correct: false,
      },
    ],
    explanation:
      "This is a sophisticated multi-vector attack: 1) The SMS was social engineering, 2) The compromised colleague added legitimacy, 3) The attacker tried to log into your account (triggering a REAL 2FA code), then 4) Called you to steal the code. NEVER share 2FA codes — they're for YOUR use only.",
  ...
  },
  {
    ...
    options: [
      {
        text: "✅ QR codes on parking meters are normal — cities are going digital",
        correct: false,
      },
      {
        text: "🚨 This is a SCAM — The QR sticker was placed OVER the original instructions (quishing attack)",
        correct: true,
      },
      {
        text: "🤔 The website looks professional so it should be safe",
        correct: false,
      },
      {
        text: "✅ I should enter my credit card to avoid a parking ticket",
        correct: false,
      },
    ],
    explanation:
      'This is "quishing" — QR code phishing. Scammers place fake QR code stickers on parking meters, restaurant tables, and public spaces. The sticker was placed over the original instructions. The URL "parksmart-citypay.com" is not a real city service. This steals credit card information.',
  ...
  },
  {
    ...
    options: [
      {
        text: "✅ They attached an official letter — I should update the banking details",
        correct: false,
      },
      {
        text: "🤔 The invoice number matches our records, so this is legitimate",
        correct: false,
      },
      {
        text: "✅ Vendors change bank details sometimes — this seems normal",
        correct: false,
      },
      {
        text: "🚨 This is a SCAM — Always verify banking changes by calling the vendor at a known number, not the one in the email",
        correct: true,
      },
    ],
    explanation:
      "This is Business Email Compromise (BEC) / vendor invoice fraud — one of the most financially damaging cyber crimes. Attackers research real business relationships, copy invoice formats, and request banking detail changes. Always verify banking changes by calling the vendor using a previously known phone number.",
...
let gameState = {
  ...
  totalAnswered: 0,
  correctCount: 0,
  aiCache: [], // AI-generated scenario cache
  aiFetching: false, // prevent duplicate fetches
};
...
function buildScenarioQueue() {
  const tierScenarios = scenarios.filter(
    (s) => s.tier === gameState.currentTier,
  );
  // Shuffle
  ...
  // Pre-fetch AI scenarios in background
  prefetchAIScenarios();
}

/**
 * Pre-fetch AI-generated scenarios from /api/game-scenario.
 * Caches up to 5 AI scenarios for the current tier.
 */
async function prefetchAIScenarios() {
  if (gameState.aiFetching) return;
  gameState.aiFetching = true;
  const lang =
    (typeof currentLang !== "undefined"
      ? currentLang
      : localStorage.getItem("cyberlang")) || "en";
  try {
    const res = await fetch(
      `/api/game-scenario?tier=${gameState.currentTier}&lang=${lang}`,
    );
    if (res.ok) {
      const data = await res.json();
      if (data && data.text && data.options) {
        // Convert AI scenario to match local format
        const aiScenario = {
          ...
          explanation: data.explanation || "AI-generated explanation.",
          tip: "💡 This scenario was dynamically generated by ASI-1 AI.",
          isAI: true,
        };
        gameState.aiCache.push(aiScenario);
      }
    }
  } catch (e) {
    /* silently fail — hardcoded scenarios always available */
  }
  gameState.aiFetching = false;
}

/**
 * Fetch a teacher-style AI explanation when the player answers incorrectly.
 * @param {Object} scenario - The current scenario object
 * @param {HTMLElement} feedbackText - The DOM element to append AI explanation
 */
async function fetchAIExplanation(scenario, feedbackText) {
  try {
    const res = await fetch("/api/chatbot", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        message: `The user got this wrong: "${scenario.content.substring(0, 200)}...". Explain in 1-2 friendly teacher-style sentences why this is a ${scenario.type || "scam"} and the key red flag to watch for.`,
        history: [],
        context:
          "Training Game mode — the user answered incorrectly and needs a brief educational explanation.",
      }),
    });
    if (res.ok) {
      const data = await res.json();
...
function handleAnswer(index, correct) {
  ...
  if (correct) {
    ...
    // Fetch AI teacher-style explanation for wrong answers
    fetchAIExplanation(scenario, feedbackText);
  }
...
function nextScenario() {
  ...
  // Every 3rd scenario, try to inject an AI-generated one
  if (gameState.currentIndex % 3 === 0 && gameState.aiCache.length > 0) {
    const aiScenario = gameState.aiCache.shift();
    gameState.scenarioQueue.splice(gameState.currentIndex, 0, aiScenario);
    // Pre-fetch more AI scenarios
    prefetchAIScenarios();
  }
...
function updateUI() {
  ...
  if (rank.next) {
    const progress =
      ((gameState.score - rank.min) / (rank.next - rank.min)) * 100;
    document.getElementById("rankProgress").style.width =
      Math.min(progress, 100) + "%";
    document.getElementById("nextRankInfo").textContent = t(
      "game.nextRankInfo",
    ).replace("{0}", rank.next);
  } else {
...
async function submitScore() {
  ...
  if (!name) {
    document.getElementById("playerName").style.borderColor =
      "var(--accent-red)";
    return;
  }
